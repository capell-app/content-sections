...
- **Sections**: the library of reusable sections you have built.
- **The section editor**: where you add content and blocks to a section.
- **The page editor**: where you insert a saved section into a page.

## What you can do

- Build a reusable section from blocks and images.
- Insert a section into any page.
- Edit a section once and update it everywhere it is used.
- Name sections clearly so editors can find them.
...
For how to use Content Sections, see the [admin guide](admin-guide.md).
