...
class ActionsRepeater extends Repeater
{
                ...
                Grid::make()
                    ...
                    ->schema([
                        ...
                        Select::make('color')
                            ...
                            ->options(ActionColor::class),
                        Select::make('target')
                            ->label(__('capell-admin::form.url_target'))
                            ->options(ActionTarget::class),
                    ]),
            ]);
    }
    ...
    {
        $actionClass = ListPublicActionOptionsAction::class;

        if (! class_exists($actionClass) || ! CapellCore::isPackageInstalled('capell-app/public-actions')) {
            return [];
        }

        $options = resolve($actionClass)->handle();
